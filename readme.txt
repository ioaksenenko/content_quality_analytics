...
2. Install virtual environment: sudo pip install virtualenv
3. Create virtual environment: virtualenv venv
4. Activate virtual environment: source {/path/to/venv}/bin/activate
5. Upgrade pip: pip3 install --upgrade pip
6. Install project requirements: pip3 install -r requirements.txt
7. Install install the necessary dictionaries: python3 -c "import nltk; nltk.download('stopwords'); nltk.download('punkt')"
8. Prepare django migrations: python3 manage.py makemigrations
9. Make django migrations: python3 manage.py migrate
10. Run the project: python3 manage.py runserver 0.0.0.0:8000